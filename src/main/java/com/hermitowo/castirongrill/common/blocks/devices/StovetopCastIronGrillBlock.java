...
public class StovetopCastIronGrillBlock extends BottomSupportedDeviceBlock implements IHighlightHandler
{
    ...
    {
        if (!entity.fireImmune() && entity instanceof LivingEntity && !EnchantmentHelper.hasFrostWalker((LivingEntity) entity) && level.getBlockEntity(pos) instanceof StovetopCastIronGrillBlockEntity grill && grill.getTemperature() > 0)
        {
